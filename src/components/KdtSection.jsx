...
const KdtSection = () => {
  return (
    <>
      <section className="container mt-20  max-w-screen-xl mx-auto px-6">
        <TitleBar title="KDT 테킷 스쿨" desc="K-Digital Training 부트캠프" />
        <div className=" mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 justify-items-start">
          {kdtCardData.map((v, i) => (
            <KdtCard
              key={i}
              image={v.image}
